...
import static contactapi.constant.Constant.X_REQUESTED_WITH;
...
public class Config {
    ...
    public CorsFilter corsFilter() {
        ...
        corsConfiguration.setAllowedOrigins(List.of("http://localhost:3000", "http://localhost:3001", "http://localhost:8080"));
